...
/* ========================================================================== 
  ...
  var _id_ = Math.ceil(Math.random() * 255);
  cmd.writeUInt8(0x12, 0);  // Connection Parameter Update Request(Vol 3, Part A, Section 4.20)
  cmd.writeUInt8(_id_, 1);
  cmd.writeUInt16LE(8,   2);  // length
  cmd.writeUInt16LE(16,  4);  // intervalMin
  cmd.writeUInt16LE(160, 6);  // intervalMax
  cmd.writeUInt16LE(9,   8);  // slaveLatency
  cmd.writeUInt16LE(600,10);  // timeoutMultiplier
  this._hci.writeAclDataPkt(handle, 0x05, cmd);
============================================================================ */
