...
Gatt.prototype.handleMtuRequest = function(request) {
  ...
  debug('handleMtuReq ' + mtu);
  this.emit('mtu', null, this._mtu);
    ...
    if (handleProperties && (handleProperties & 0x08)) {
      ...
      var callback = (function(request) {
        return function(result) {
          ...
          debug('prepareWrite response: ' + callbackResponse.toString('hex'));
  ...
  if (handle) {
    ...
    var callback = (function(flag) {
      return function(result) {
        ...
        debug('execWrite response: ' + callbackResponse.toString('hex'));
